package com.found_404.funcomember.global.security.service;

import static com.found_404.funcomember.auth.type.OauthServerType.*;
...
import com.found_404.funcomember.global.security.exception.SecurityException;
...
public class TokenService {
	...
	public TokenResponse reissueAccessToken(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			Member member = memberRepository.findByOauthId(new OauthId(oauthServerId, GOOGLE))
				.orElseThrow(() -> new SecurityException(MEMBER_NOT_FOUND, HttpStatus.UNAUTHORIZED));
