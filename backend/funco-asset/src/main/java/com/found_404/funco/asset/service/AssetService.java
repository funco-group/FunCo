...
public class AssetService {
	...
	public void saveDataToAssetHistory(TotalAssetHistoryRequest totalAssetHistoryRequest, AssetType assetType) {
		assetHistoryRepository.save(AssetHistory.builder()
				...
				.assetType(assetType)
				.assetTradeType(totalAssetHistoryRequest.getAssetTradeType())
				...
				.settlement(totalAssetHistoryRequest.getSettlement())
				.beginningCash(totalAssetHistoryRequest.getEndingCash() - totalAssetHistoryRequest.getOrderCash())
				.endingCash(totalAssetHistoryRequest.getEndingCash())
				.orderCash(totalAssetHistoryRequest.getOrderCash())
				.ticker(totalAssetHistoryRequest.getTicker())
				.portfolioName(totalAssetHistoryRequest.getPortfolioName())
				.investment(totalAssetHistoryRequest.getInvestment())
				.followName(totalAssetHistoryRequest.getFollowName())
				.followDate(totalAssetHistoryRequest.getFollowDate())
				.followReturnRate(totalAssetHistoryRequest.getFollowReturnRate())
				.build());
	}
